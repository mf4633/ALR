...
body(
    ...
    f"At 500 particles, ALR achieves {cost.errors_vorticity[1]:.1%} vorticity "
    f"error with a 12-fold particle reduction and total vortex strength conserved "
    f"to within 0.1% via the symmetrized Biot-Savart kernel. A quasi-unsteady sediment "
